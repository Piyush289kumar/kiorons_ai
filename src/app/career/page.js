    ...
    <>
      ...
      >
        <div>
          ...
          <p className="text-lg mt-5 max-w-md mx-auto font-medium px-7">
            {"If you're obsessed with shaping what comes next you belong here."}
          </p>
        </div>
      </section>
      <CareerSubSection />
      <section className="py-16 sm:py-0  font-gellix mx-auto text-center w-full xl:px-12 xl:max-w-8xl px-7">
        <div className="px-12 md:px-0">
          <h2 className="text-3xl sm:text-6xl font-semibold mb-5 text-zinc-50 max-w-2xl mx-auto">
          Featured Roles
        </h2>
        <p className="text-md text-primary font-normal mb-8 max-w-lg mx-auto">
          We’re looking for curious minds from a wide range of disciplines and
          backgrounds.
        </p>
        </div>
        <GlassButton className="mt-2 !py-2 text-xs md:text-sm font-normal">
          View All Roles
        </GlassButton>
        {/* <GlassButtonWithText
          as="a"
