              ...
              <div className="!text-center !max-w-6xl !mx-auto !px-4 !relative">
                ...
                <div className="!relative !w-full !h-[500px] !mt-12 !overflow-visible">
                  <Image
                    ...
                    width={350}
                    height={350}
                    className="!absolute !z-0 !shadow-lg -left-[65%] top-[5%] sm:-left-[40%] sm:top-[10%] xs:static xs:mx-auto xs:mb-6 xs:relative"
                  />
                  <Image
                    ...
                    width={350}
                    height={350}
                    className="!absolute !z-10 !shadow-lg -left-[25%] top-[25%] sm:-left-[15%] sm:top-[25%] xs:static xs:mx-auto xs:mb-6 xs:relative"
                  />
                  <Image
                    ...
                    width={350}
                    height={350}
                    className="!absolute !z-10 !shadow-lg -right-[25%] top-[25%] sm:-right-[15%] sm:top-[25%] xs:static xs:mx-auto xs:mb-6 xs:relative"
                  />
                  <Image
                    ...
                    width={350}
                    height={350}
                    className="!absolute !z-0 !shadow-lg -right-[65%] top-[5%] sm:-right-[40%] sm:top-[10%] xs:static xs:mx-auto xs:mb-6 xs:relative"
                  />
                  <Image
