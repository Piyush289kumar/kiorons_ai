...
export default function Footer() {
  return (
    <footer className="w-full max-w-6xl mx-auto py-40 text-white">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Explore Section */}
        <div className="space-y-4">
          <h4 className="text-[#B8B8B8] text-lg">Explore</h4>
        ...
        <div className="space-y-4">
          <h4 className="text-lg text-[#B8B8B8]">Terms & Policies</h4>
          <ul className="space-y-2">
        ...
        <div className="space-y-4 flex flex-col items-start">
          ...
          <p className="text-white leading-1">Crafted with intent in India.</p>
        </div>
      </div>
    </footer>
  )
